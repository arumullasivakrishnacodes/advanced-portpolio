...
export const Experience = [
    {
        ...
        work: [
            ...
            'Design, develop and test HTML, CSS3, JavaScript and jQuery that meets accessibility and web browser standards for website.',
            '3rd party Integrations, Performance Optimizations',
            'Development new features usinh HTML, CSS and javascript',
            'Training and Knowledge Sharing',
            'Enhancements on new requirements to make website faster and good looking',
